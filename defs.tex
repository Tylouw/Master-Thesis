...
\makeatletter
\providecommand*{\toclevel@plainchapter}{0}
\newcommand*\l@plainchapter[2]{%
...
% resources
\addbibresource{chapters/2-background_and_related_works/bg.bib}
\addbibresource{chapters/4-dataset_construction_and_labeling/dataset.bib}
\addbibresource{chapters/5-patchtst/meth.bib}
